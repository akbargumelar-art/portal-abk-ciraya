...
const MarketingFeePage: React.FC = () => {
    return (
        <div className="p-6 animate-fade-in">
            <Header title="Marketing Fee" />
            <Card className="mt-6 text-center py-16">
                ...
                <p className="text-gray-500">Fitur Marketing Fee akan segera tersedia.</p>
            </Card>
        </div>
    );
};

export default MarketingFeePage;
