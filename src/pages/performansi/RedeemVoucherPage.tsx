/**
 * Redeem Voucher Fisik Performance Page
 * 
 * Revenue & Quantity metrics for Simpati and byU products - Redeem Voucher
...
import { aktifasiData as redeemData } from '../../services/mock/aktifasiData';
...
const DailyTrendChart: React.FC<{ areaFilter: string, isRevenue: boolean }> = memo(({ areaFilter, isRevenue }) => {
    const trendData = isRevenue ? redeemData.dailyTrendRevenue : redeemData.dailyTrendQuantity;
...
const RedeemVoucherPage: React.FC = () => {
    ...
    const summaryData = isRevenue ? redeemData.revenue : redeemData.quantity;
    ...
    return (
        <div className="p-6 animate-fade-in">
            <Header title="Performansi Redeem Voucher Fisik" subtitle="Revenue & Quantity Monitoring - Simpati & byU" />
