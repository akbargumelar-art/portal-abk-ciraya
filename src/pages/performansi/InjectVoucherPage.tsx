                    ...
                    <table className="w-full text-[10px] border-collapse whitespace-nowrap">
                        <thead className="sticky top-0 z-10">
                            ...
                            <tr className="bg-[#3d5f85]">
                                {/* Simpati */}
                                {headerCols.map(col => <th key={`s-${col}`} className="p-1.5 border text-center text-white bg-red-50">{col}</th>)}
                                {/* byU */}
                                {headerCols.map(col => <th key={`b-${col}`} className="p-1.5 border text-center text-white bg-purple-50">{col}</th>)}
                                {/* Total */}
                                {headerCols.map(col => <th key={`t-${col}`} className="p-1.5 border text-center text-white bg-blue-50">{col}</th>)}
                            </tr>
                        </thead>
                        <tbody>
                            {data.map((row, idx) => {
